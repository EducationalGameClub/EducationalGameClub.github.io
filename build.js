...
async function main() {
  ...
  const events = [
    ...
    {
      uid: 'c029f388-8b57-48d1-9c5b-521db663785a',
      title: 'Discussion of Wake: Tales from the Aqualab',
      brief: `We'll be discussing Wake: Tales from the Aqualab (2023) by Field Day. Play as a young scientist exploring ocean ecosystems and conducting experiments based on real research.`,
      start: makeUtcDate(2026, 3, 26, 1),
      duration: { hours: 1, minutes: 30 },
